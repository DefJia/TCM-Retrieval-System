...
class Ui_Information(object):
    def setupUi(self, Information):
        ...
        self.gridLayout.addWidget(self.DBOutput, 7, 2, 1, 1)
        ...
        self.boxGender = QtWidgets.QComboBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.boxGender.addItem("")
        self.horizontalLayout_4.addWidget(self.boxGender)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_4.addWidget(self.label_2)
        self.gridLayout.addLayout(self.horizontalLayout_4, 0, 4, 1, 3)
        self.DBInput = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.DBInput.setFont(font)
        self.DBInput.setObjectName("DBInput")
        self.gridLayout.addWidget(self.DBInput, 7, 4, 1, 1)
        self.option = QtWidgets.QTableWidget(self.centralwidget)
        self.option.setGeometry(QtCore.QRect(10, 210, 256, 171))
    ...
    def retranslateUi(self, Information):
        ...
        self.boxGender.setItemText(0, _translate("Information", "男"))
        self.boxGender.setItemText(1, _translate("Information", "女"))
        self.label_2.setText(_translate("Information", "       "))
        self.DBInput.setText(_translate("Information", "数据库导入"))
