...
class Ui_Information(object):
    def setupUi(self, Information):
        ...
        self.gridLayout.addLayout(self.formLayout, 5, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.IButtonGetinUI, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.IButtonOut, 6, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.IButtonInquire, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.tablewidgetMainSymptom, 4, 0, 1, 2)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_6, 2, 2, 1, 3)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_5, 1, 2, 1, 3)
