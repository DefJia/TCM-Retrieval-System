...
class Ui_Information(object):
    def setupUi(self, Information):
        ...
        self.tablewidgetMainSymptom = QtWidgets.QLineEdit(self.centralwidget)
        self.tablewidgetMainSymptom.setGeometry(QtCore.QRect(50, 250, 461, 171))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.tablewidgetMainSymptom.setFont(font)
        ...
        self.widget.setGeometry(QtCore.QRect(50, 440, 841, 251))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_18)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_19)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit_20)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.lineEdit_21)
