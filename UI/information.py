...
class Ui_Information(object):
    def setupUi(self, Information):
        ...
        self.DBIutput = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.DBIutput.setFont(font)
        self.DBIutput.setObjectName("DBIutput")
        self.gridLayout.addWidget(self.DBIutput, 7, 4, 1, 1)
    ...
    def retranslateUi(self, Information):
        ...
        self.DBIutput.setText(_translate("Information", "数据库导入"))
