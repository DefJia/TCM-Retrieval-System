...
class Ui_reminder(object):
    def setupUi(self, reminder):
        ...
        self.buttonYes.setGeometry(QtCore.QRect(80, 130, 101, 51))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.buttonYes.sizePolicy().hasHeightForWidth())
        self.buttonYes.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        ...
        self.buttonNo.setGeometry(QtCore.QRect(210, 130, 101, 51))
        font = QtGui.QFont()
        font.setFamily("Academy Engraved LET")
        font.setPointSize(20)
    ...
    def retranslateUi(self, reminder):
        ...
        self.buttonYes.setShortcut(_translate("reminder", "Return"))
