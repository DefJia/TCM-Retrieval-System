...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupboxSymptom.setGeometry(QtCore.QRect(10, 70, 211, 411))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.tablewidgetPrescribe.horizontalHeader().setVisible(False)
        ...
        self.tablewidgetPrescribe.horizontalHeader().setStretchLastSection(True)
        self.tablewidgetBook = QtWidgets.QTableWidget(self.centralwidget)
        self.tablewidgetBook.setGeometry(QtCore.QRect(990, 100, 361, 711))
        ...
        self.tablewidgetBook.setColumnCount(1)
        self.tablewidgetBook.setRowCount(0)
        self.tablewidgetBook.horizontalHeader().setVisible(False)
        self.tablewidgetBook.horizontalHeader().setStretchLastSection(True)
        # self.tablewidgetBook.horizontalHeader().resizeToContents()
        self.tablewidgetBook.verticalHeader().setVisible(False)
        ...
        self.groupboxDisease.setGeometry(QtCore.QRect(220, 70, 241, 411))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(26)
        ...
        self.groupboxPrescription.setGeometry(QtCore.QRect(460, 70, 241, 411))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(26)
        ...
        self.groupboxMedicine.setGeometry(QtCore.QRect(700, 70, 251, 411))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(26)
        ...
        self.buttonSave.setGeometry(QtCore.QRect(750, 830, 161, 51))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(20)
        ...
        self.radioButton.setGeometry(QtCore.QRect(530, 30, 181, 31))
        font = QtGui.QFont()
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(760, 30, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Academy Engraved LET")
        font.setPointSize(20)
        font.setBold(False)
        ...
        self.labelType.setGeometry(QtCore.QRect(230, -10, 261, 91))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(28)
        ...
        self.buttonDeleterelation.setGeometry(QtCore.QRect(30, 490, 151, 51))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(20)
        ...
        self.buttonOut.setGeometry(QtCore.QRect(1180, 820, 171, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelPosition_2.setText(_translate("MainWindow", "记录"))
